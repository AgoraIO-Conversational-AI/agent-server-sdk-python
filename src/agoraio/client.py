...
class Agora:
    ...
    def __init__(
        ...
        *,
        ...
        self.agent_management = AgentManagementClient(client_wrapper=self._client_wrapper)
        self.telephony = TelephonyClient(client_wrapper=self._client_wrapper)
        self.phone_number_management = PhoneNumberManagementClient(client_wrapper=self._client_wrapper)
...
class AsyncAgora:
    ...
    def __init__(
        ...
        *,
        ...
        self.agent_management = AsyncAgentManagementClient(client_wrapper=self._client_wrapper)
        self.telephony = AsyncTelephonyClient(client_wrapper=self._client_wrapper)
        self.phone_number_management = AsyncPhoneNumberManagementClient(client_wrapper=self._client_wrapper)
