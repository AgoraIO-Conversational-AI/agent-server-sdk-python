...
from .start_agents_request_properties_tts_vendor import StartAgentsRequestPropertiesTtsVendor


class StartAgentsRequestPropertiesTts(UncheckedBaseModel):
    """
    Text-to-speech (TTS) module configuration.
    """

    vendor: StartAgentsRequestPropertiesTtsVendor = pydantic.Field()
    """
    TTS provider:
