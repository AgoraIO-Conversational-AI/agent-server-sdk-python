...
from .import_number_response_associated_pipeline import ImportNumberResponseAssociatedPipeline


class ImportNumberResponse(UncheckedBaseModel):
    ...
    associated_pipeline: typing.Optional[ImportNumberResponseAssociatedPipeline] = pydantic.Field(default=None)
    """
