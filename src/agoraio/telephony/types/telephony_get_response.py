...
from .telephony_get_response_reason import TelephonyGetResponseReason
from .telephony_get_response_state import TelephonyGetResponseState
from .telephony_get_response_type import TelephonyGetResponseType


class TelephonyGetResponse(UncheckedBaseModel):
    ...
    type: typing.Optional[TelephonyGetResponseType] = pydantic.Field(default=None)
    """
    Call type:
    ...
    reason: typing.Optional[TelephonyGetResponseReason] = pydantic.Field(default=None)
    """
    ...
    state: typing.Optional[TelephonyGetResponseState] = pydantic.Field(default=None)
    """
    Call status:
