...
from .telephony_list_response_data_list_item_state import TelephonyListResponseDataListItemState
from .telephony_list_response_data_list_item_type import TelephonyListResponseDataListItemType


class TelephonyListResponseDataListItem(UncheckedBaseModel):
    ...
    type: typing.Optional[TelephonyListResponseDataListItemType] = pydantic.Field(default=None)
    """
    Call type:
    ...
    state: typing.Optional[TelephonyListResponseDataListItemState] = pydantic.Field(default=None)
    """
    Call status:
