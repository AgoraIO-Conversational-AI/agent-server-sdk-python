...
from .start_agent_management_request_properties_mllm_vendor import StartAgentManagementRequestPropertiesMllmVendor


class StartAgentManagementRequestPropertiesMllm(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[StartAgentManagementRequestPropertiesMllmVendor] = pydantic.Field(default=None)
    """
