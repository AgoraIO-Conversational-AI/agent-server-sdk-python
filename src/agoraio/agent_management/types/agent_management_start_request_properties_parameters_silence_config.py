...
from .agent_management_start_request_properties_parameters_silence_config_action import (
    AgentManagementStartRequestPropertiesParametersSilenceConfigAction,
)


class AgentManagementStartRequestPropertiesParametersSilenceConfig(UncheckedBaseModel):
    """
    ...
    action: typing.Optional[AgentManagementStartRequestPropertiesParametersSilenceConfigAction] = pydantic.Field(
        default=None
    )
    """
