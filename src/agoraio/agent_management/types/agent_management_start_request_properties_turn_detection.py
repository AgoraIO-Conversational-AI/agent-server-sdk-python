...
from .agent_management_start_request_properties_turn_detection_eagerness import (
    AgentManagementStartRequestPropertiesTurnDetectionEagerness,
)
from .agent_management_start_request_properties_turn_detection_interrupt_mode import (
    AgentManagementStartRequestPropertiesTurnDetectionInterruptMode,
)
from .agent_management_start_request_properties_turn_detection_type import (
    AgentManagementStartRequestPropertiesTurnDetectionType,
)


class AgentManagementStartRequestPropertiesTurnDetection(UncheckedBaseModel):
    """
    Conversation turn detection settings.
    """

    type: typing.Optional[AgentManagementStartRequestPropertiesTurnDetectionType] = pydantic.Field(default=None)
    """
    ...
    interrupt_mode: typing.Optional[AgentManagementStartRequestPropertiesTurnDetectionInterruptMode] = pydantic.Field(
        default=None
    )
    """
    ...
    eagerness: typing.Optional[AgentManagementStartRequestPropertiesTurnDetectionEagerness] = pydantic.Field(
        default=None
    )
    """
