...
from .start_agent_management_request_properties_sal_sal_mode import StartAgentManagementRequestPropertiesSalSalMode


class StartAgentManagementRequestPropertiesSal(UncheckedBaseModel):
    """
    Selective Attention Locking (SAL) configuration.
    """

    sal_mode: typing.Optional[StartAgentManagementRequestPropertiesSalSalMode] = pydantic.Field(default=None)
    """
