...
from .start_agent_management_request_properties_parameters_silence_config_action import (
    StartAgentManagementRequestPropertiesParametersSilenceConfigAction,
)


class StartAgentManagementRequestPropertiesParametersSilenceConfig(UncheckedBaseModel):
    """
    ...
    action: typing.Optional[StartAgentManagementRequestPropertiesParametersSilenceConfigAction] = pydantic.Field(
        default=None
    )
    """
