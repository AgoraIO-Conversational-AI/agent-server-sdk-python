...
from .start_agent_request_properties_parameters_silence_config_action import (
    StartAgentRequestPropertiesParametersSilenceConfigAction,
)


class StartAgentRequestPropertiesParametersSilenceConfig(UncheckedBaseModel):
    """
    ...
    action: typing.Optional[StartAgentRequestPropertiesParametersSilenceConfigAction] = pydantic.Field(default=None)
    """
