...
from .start_agent_management_request_properties_llm_style import StartAgentManagementRequestPropertiesLlmStyle


class StartAgentManagementRequestPropertiesLlm(UncheckedBaseModel):
    """
    ...
    style: typing.Optional[StartAgentManagementRequestPropertiesLlmStyle] = pydantic.Field(default=None)
    """
