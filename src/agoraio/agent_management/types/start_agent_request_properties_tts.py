...
from .start_agent_request_properties_tts_vendor import StartAgentRequestPropertiesTtsVendor


class StartAgentRequestPropertiesTts(UncheckedBaseModel):
    """
    Text-to-speech (TTS) module configuration.
    """

    vendor: StartAgentRequestPropertiesTtsVendor = pydantic.Field()
    """
    TTS provider:
