...
from .start_agent_request_properties_llm_style import StartAgentRequestPropertiesLlmStyle


class StartAgentRequestPropertiesLlm(UncheckedBaseModel):
    """
    ...
    style: typing.Optional[StartAgentRequestPropertiesLlmStyle] = pydantic.Field(default=None)
    """
