...
from .start_agent_request_properties_sal_sal_mode import StartAgentRequestPropertiesSalSalMode


class StartAgentRequestPropertiesSal(UncheckedBaseModel):
    """
    Selective Attention Locking (SAL) configuration.
    """

    sal_mode: typing.Optional[StartAgentRequestPropertiesSalSalMode] = pydantic.Field(default=None)
    """
