...
from .agent_management_start_request_properties_avatar_vendor import AgentManagementStartRequestPropertiesAvatarVendor


class AgentManagementStartRequestPropertiesAvatar(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[AgentManagementStartRequestPropertiesAvatarVendor] = pydantic.Field(default=None)
    """
