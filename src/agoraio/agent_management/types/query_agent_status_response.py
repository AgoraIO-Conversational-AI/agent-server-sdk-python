...
from .query_agent_status_response_status import QueryAgentStatusResponseStatus


class QueryAgentStatusResponse(UncheckedBaseModel):
    ...
    status: typing.Optional[QueryAgentStatusResponseStatus] = pydantic.Field(default=None)
    """
    Current status:
