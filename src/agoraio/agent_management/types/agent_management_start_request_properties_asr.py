...
from .agent_management_start_request_properties_asr_vendor import AgentManagementStartRequestPropertiesAsrVendor


class AgentManagementStartRequestPropertiesAsr(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[AgentManagementStartRequestPropertiesAsrVendor] = pydantic.Field(default=None)
    """
    ASR provider:
