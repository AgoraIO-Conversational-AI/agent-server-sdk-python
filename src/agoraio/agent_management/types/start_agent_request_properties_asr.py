...
from .start_agent_request_properties_asr_vendor import StartAgentRequestPropertiesAsrVendor


class StartAgentRequestPropertiesAsr(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[StartAgentRequestPropertiesAsrVendor] = pydantic.Field(default=None)
    """
    ASR provider:
