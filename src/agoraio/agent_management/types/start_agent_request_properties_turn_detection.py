...
from .start_agent_request_properties_turn_detection_eagerness import StartAgentRequestPropertiesTurnDetectionEagerness
from .start_agent_request_properties_turn_detection_interrupt_mode import (
    StartAgentRequestPropertiesTurnDetectionInterruptMode,
)
from .start_agent_request_properties_turn_detection_type import StartAgentRequestPropertiesTurnDetectionType


class StartAgentRequestPropertiesTurnDetection(UncheckedBaseModel):
    """
    Conversation turn detection settings.
    """

    type: typing.Optional[StartAgentRequestPropertiesTurnDetectionType] = pydantic.Field(default=None)
    """
    ...
    interrupt_mode: typing.Optional[StartAgentRequestPropertiesTurnDetectionInterruptMode] = pydantic.Field(
        default=None
    )
    """
    ...
    eagerness: typing.Optional[StartAgentRequestPropertiesTurnDetectionEagerness] = pydantic.Field(default=None)
    """
