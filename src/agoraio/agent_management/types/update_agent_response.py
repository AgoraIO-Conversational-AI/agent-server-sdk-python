...
from .update_agent_response_status import UpdateAgentResponseStatus


class UpdateAgentResponse(UncheckedBaseModel):
    ...
    status: typing.Optional[UpdateAgentResponseStatus] = pydantic.Field(default=None)
    """
    Current status:
