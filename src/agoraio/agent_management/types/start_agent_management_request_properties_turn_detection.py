...
from .start_agent_management_request_properties_turn_detection_eagerness import (
    StartAgentManagementRequestPropertiesTurnDetectionEagerness,
)
from .start_agent_management_request_properties_turn_detection_interrupt_mode import (
    StartAgentManagementRequestPropertiesTurnDetectionInterruptMode,
)
from .start_agent_management_request_properties_turn_detection_type import (
    StartAgentManagementRequestPropertiesTurnDetectionType,
)


class StartAgentManagementRequestPropertiesTurnDetection(UncheckedBaseModel):
    """
    Conversation turn detection settings.
    """

    type: typing.Optional[StartAgentManagementRequestPropertiesTurnDetectionType] = pydantic.Field(default=None)
    """
    ...
    interrupt_mode: typing.Optional[StartAgentManagementRequestPropertiesTurnDetectionInterruptMode] = pydantic.Field(
        default=None
    )
    """
    ...
    eagerness: typing.Optional[StartAgentManagementRequestPropertiesTurnDetectionEagerness] = pydantic.Field(
        default=None
    )
    """
