...
from .agent_management_start_request_properties_llm_style import AgentManagementStartRequestPropertiesLlmStyle


class AgentManagementStartRequestPropertiesLlm(UncheckedBaseModel):
    """
    ...
    system_messages: typing.Optional[typing.List[typing.Dict[str, typing.Optional[typing.Any]]]] = pydantic.Field(
        default=None
    )
    """
    ...
    style: typing.Optional[AgentManagementStartRequestPropertiesLlmStyle] = pydantic.Field(default=None)
    """
