...
from .get_agent_management_response_status import GetAgentManagementResponseStatus


class GetAgentManagementResponse(UncheckedBaseModel):
    ...
    status: typing.Optional[GetAgentManagementResponseStatus] = pydantic.Field(default=None)
    """
    Current status:
