...
from .agent_management_get_response_status import AgentManagementGetResponseStatus


class AgentManagementGetResponse(UncheckedBaseModel):
    ...
    status: typing.Optional[AgentManagementGetResponseStatus] = pydantic.Field(default=None)
    """
    Current status:
