...
from .start_agent_management_request_properties_asr_vendor import StartAgentManagementRequestPropertiesAsrVendor


class StartAgentManagementRequestPropertiesAsr(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[StartAgentManagementRequestPropertiesAsrVendor] = pydantic.Field(default=None)
    """
    ASR provider:
