...
from .agent_management_start_request_properties_mllm_vendor import AgentManagementStartRequestPropertiesMllmVendor


class AgentManagementStartRequestPropertiesMllm(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[AgentManagementStartRequestPropertiesMllmVendor] = pydantic.Field(default=None)
    """
