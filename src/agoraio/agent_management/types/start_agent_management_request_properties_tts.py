...
from .start_agent_management_request_properties_tts_vendor import StartAgentManagementRequestPropertiesTtsVendor


class StartAgentManagementRequestPropertiesTts(UncheckedBaseModel):
    """
    Text-to-speech (TTS) module configuration.
    """

    vendor: StartAgentManagementRequestPropertiesTtsVendor = pydantic.Field()
    """
    TTS provider:
