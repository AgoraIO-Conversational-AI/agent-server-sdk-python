...
from .agent_management_start_request_properties_sal_sal_mode import AgentManagementStartRequestPropertiesSalSalMode


class AgentManagementStartRequestPropertiesSal(UncheckedBaseModel):
    """
    Selective Attention Locking (SAL) configuration.
    """

    sal_mode: typing.Optional[AgentManagementStartRequestPropertiesSalSalMode] = pydantic.Field(default=None)
    """
