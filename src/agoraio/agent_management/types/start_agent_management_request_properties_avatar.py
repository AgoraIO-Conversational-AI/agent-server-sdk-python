...
from .start_agent_management_request_properties_avatar_vendor import StartAgentManagementRequestPropertiesAvatarVendor


class StartAgentManagementRequestPropertiesAvatar(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[StartAgentManagementRequestPropertiesAvatarVendor] = pydantic.Field(default=None)
    """
