...
from .start_agent_request_properties_avatar_vendor import StartAgentRequestPropertiesAvatarVendor


class StartAgentRequestPropertiesAvatar(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[StartAgentRequestPropertiesAvatarVendor] = pydantic.Field(default=None)
    """
